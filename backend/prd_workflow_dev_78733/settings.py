"""
Django settings for prd_workflow_dev_78733 project.
...
ROOT_URLCONF = 'prd_workflow_dev_78733.urls'
...
WSGI_APPLICATION = 'prd_workflow_dev_78733.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_workflow_dev_78733 API",
    "DESCRIPTION": "API documentation for prd_workflow_dev_78733 App",
    "VERSION": "v1",
}
